...
class MapView: UIView {
    ...
    private func setLayout(){
        ...
        trackingButton.rightAnchor.constraint(equalTo: rightAnchor, constant: -40).isActive = true
        trackingButton.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -100).isActive = true
        trackingButton.heightAnchor.constraint(equalToConstant: 60).isActive = true
        trackingButton.widthAnchor.constraint(equalToConstant: 60).isActive = true
    }
}
